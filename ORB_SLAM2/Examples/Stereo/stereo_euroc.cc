...
const string output_yaml = "src/ORB_SLAM2/Examples/Stereo/output.yaml";
void rm_fisheye()
{
...
{
    //-----------------ORB_SLAM2 Init---------------------------------------------
    const string param1_ORBvoc = "src/ORB_SLAM2/Vocabulary/ORBvoc.txt";
    
    const string param3_ORByaml = "src/ORB_SLAM2/Examples/Stereo/EuRoC.yaml";
    
    
    ORB_SLAM2::System SLAM(param1_ORBvoc,param3_ORByaml,output_yaml,ORB_SLAM2::System::STEREO,true);
...
int main(int argc, char **argv)
{
    ...
    const char *param2_SDKyaml =  "../lib/1604/headset.yaml";
